...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 168.857147, 898.0, 33.0, 23.0 ],
					"style" : "",
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 168.857147, 823.0, 65.0, 23.0 ],
					"style" : "",
					"text" : "bach.push"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 24.000011, 784.0, 78.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 24.000011, 784.0, 78.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 24.000011, 823.0, 52.0, 23.0 ],
					"style" : "",
					"text" : "t clear b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 51.000011, 975.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 440.857147, 331.0, 41.0, 23.0 ],
					"style" : "",
					"text" : "sel 97"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 440.857147, 301.0, 50.5, 23.0 ],
					"style" : "",
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 59.0, 29.5, 23.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 323.0, 43.0, 48.0, 23.0 ],
					"style" : "",
					"text" : "sel 110"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "int", "int", "int" ],
					"patching_rect" : [ 323.0, 16.0, 50.5, 23.0 ],
					"style" : "",
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 39.0, 125.0, 56.0, 23.0 ],
					"style" : "",
					"text" : "stripnote"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.0, 390.0, 56.0, 23.0 ],
					"style" : "",
					"text" : "r division"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 208.0, 16.0, 59.0, 23.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 154.0, 63.0, 91.0, 22.0 ],
									"style" : "",
									"text" : "loadmess clear"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-92", 0 ],
									"midpoints" : [ 163.5, 171.0, 59.5, 171.0 ],
									"source" : [ "obj-70", 0 ]
								}
...
,
					"patching_rect" : [ 440.857147, 418.0, 73.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 489.857178, 368.5, 132.0, 25.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 440.857147, 362.0, 39.407406, 38.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 5,
									"outlettype" : [ "bang", "(0)", "", "(1500)", "clear" ],
									"patching_rect" : [ 165.0, 384.0, 193.0, 22.0 ],
									"style" : "",
									"text" : "t b (0) l (1500) clear"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 165.0, 444.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 252.0, 444.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 295.5, 444.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 208.5, 444.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 24.0, 418.0, 324.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 174.0, 33.0, 23.0 ],
					"style" : "",
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 24.000011, 470.0, 526.0, 264.833344 ],
					"pitcheditrange" : [ "null" ],
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 261.0, 176.0, 264.833344 ],
					"showdurations" : 0,
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7900,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 24.0, 235.0, 572.0, 49.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 39.0, 16.0, 93.0, 23.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 243.0, 102.0, 106.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 257.0, 148.0, 79.0, 23.0 ],
					"style" : "",
					"text" : "send division"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 178.0, 35.0, 23.0 ],
					"style" : "",
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 208.0, 148.0, 35.0, 23.0 ],
					"style" : "",
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 208.0, 102.0, 28.0, 28.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 168.857147, 779.0, 65.0, 23.0 ],
					"style" : "",
					"text" : "bach.flat 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 168.857147, 858.0, 75.0, 23.0 ],
					"style" : "",
					"text" : "bach.wrap 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 332.5, 87.0, 217.5, 87.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 338.5, 444.0, 337.700012, 444.0 ],
					"source" : [ "obj-24", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 236.833328, 444.0, 236.300018, 444.0 ],
					"source" : [ "obj-24", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 135.166672, 465.0, 134.900009, 465.0 ],
					"source" : [ "obj-24", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 33.5, 444.0, 33.500011, 444.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-60", 0 ],
					"midpoints" : [ 450.357147, 456.0, 33.500011, 456.0 ],
					"source" : [ "obj-93", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "array.js",
				"bootpath" : "~/SoundLibrary/Github/2s-max-library/javascript",
				"patcherrelativepath" : "../../2s-max-library/javascript",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
				"name" : "bach.push.maxpat",
